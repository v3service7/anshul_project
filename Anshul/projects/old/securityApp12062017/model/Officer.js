...
var OfficerSchema = new Schema({
    ...
    policeService :  {unitName: {type: String, trim: true }, startYear:Number, endYear:Number},
    militaryService : { unitName: {type: String, trim: true }, startYear:Number, endYear:Number},
    phones : [{ 
