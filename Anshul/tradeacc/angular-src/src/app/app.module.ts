...
import { CityComponent, CityListComponent , CityAddComponent, CityEditComponent } from './admin/city/city.component';
...
@NgModule({
  declarations: [
    ...
    DashboardComponent,
    ProfileComponent,
    CityComponent, CityListComponent , CityAddComponent, CityEditComponent,
  ...
  providers: [ValidateService, AdminService, AuthGuard, UserService, PlanService, PagesService, ExchangeService, CitiesService],
